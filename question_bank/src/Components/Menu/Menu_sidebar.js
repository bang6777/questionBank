        ...
        return (
            <div className="col-md-2 menu-left col-sm-12">
                ...
                <ul className="main-menu">
                    ...
                    <li className="menu-tp"><a href="# ">Quản Lý Ngân Hàng Câu Hỏi<span className="caret"> </span></a>
                        <ul className="sub-menu">
                    ...
                    <li className="menu-tp"><a href="# ">Sinh Viên<span className="caret"> </span></a>
                    </li>
                    <li className="menu-tp"><a href="# ">Điểm<span className="caret"> </span></a>
                    </li>
