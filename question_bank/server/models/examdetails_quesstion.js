...
module.exports = (sequelize, DataTypes) => {
  ...
  ExamDetails_Quesstion.associate=function(models){
    ExamDetails_Quesstion.belongsTo(models.Quesstion,{as: 'Id_Quesstion', foreignKey :  'Id_quesstion'});
    ExamDetails_Quesstion.belongsTo(models.ExamDetails,{as: 'Id_Examdetails', foreignKey :  'Id_examdetails'});
